# -*- coding: utf-8 -*-
"""
Created on Sat May 15 19:02:00 2021

@author: selcuk
"""
from vehicle_project import BikeRent,CarRent,Customer
...
while True:
    ...
    if choice == "A" or choice == "a":
        ...
        if choice == 1:
            ...
            customer_bill = bike.returnVehicle(customer.returnVehicle("bike"), "bike")
            customer.rentalBasis_b, customer.rentalTime_b, customer_bikes = 0,0,0
            main_menu == True
        elif choice == 5:
            main_menu == True
        elif choice == 6:
        ...
        if choice == 1:
            ...
            # rentalTime = when it did rent?
            # rentalBasis = daily or hourly
            # numOfVehicle = count of Vehicle
            customer_bill = car.returnVehicle(customer.returnVehicle("car"), "car")
            customer.rentalBasis_c, customer.rentalTime_c, customer_cars = 0,0,0
        elif choice == 5:
            main_menu == True
        elif choice == 6:
            break
